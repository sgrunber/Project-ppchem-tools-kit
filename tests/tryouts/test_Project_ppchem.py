...
# Get the absolute path of the directory containing Project_ppchem.py
module_path = os.path.abspath(os.path.join('..', 'Project_ppchem.py'))
/Users/meloenzinger/Documents/GitHub/Project-ppchem-tools-kit-bis/Project_ppchem.py
